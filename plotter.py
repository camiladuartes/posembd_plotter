...
def addToPlot(toPlot, info, columnDict):
    toPlot['embeddings1'].append((info[columnDict['tsne_0_0']], info[columnDict['tsne_0_1']]))
    toPlot['embeddings2'].append((info[columnDict['tsne_1_0']], info[columnDict['tsne_1_1']]))
    toPlot['embeddings3'].append((info[columnDict['tsne_2_0']], info[columnDict['tsne_2_1']]))
    toPlot['embeddings4'].append((info[columnDict['tsne_3_0']], info[columnDict['tsne_3_1']]))

def plotter(infos, columnDict, vocab):
    while True:
...
_, vocab = readVocabFile(vocabPath)

plotter(infos, columnDict, vocab)
